...
export const QA_OVER_PAPER_PROMPT = ChatPromptTemplate.fromMessages([
  [
    "ai",
    `You are an expert in financial analysis and strategic business advice.
Your client has a question regarding a financial report they are reading.
...
Answer the client's question in the context of the paper. You should also suggest followup questions.
    ...
    parameters: {
      ...
      properties: {
        ...
        followupQuestions: {
          ...
          items: {
            type: "string",
            description: "Followup questions the client should also ask",
          },
        },
      },
